...
class CalculatorApp(tk.Tk):
    ...
    def create_widgets(self, parent_frame):
        ...
        display = tk.Entry(parent_frame, textvariable=self.result_var, font=("Helvetica", 20))
        ...
        # self.label2 = tk.Label(frame2, text="Using Grid", bg="green")
        # self.label2.pack()
        
        # self.label3 = tk.Label(frame2, text="Using Grid2", bg="red")
        # self.label3.pack()
